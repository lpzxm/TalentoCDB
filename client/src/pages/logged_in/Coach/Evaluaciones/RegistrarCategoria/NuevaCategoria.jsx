...
<center>
    <div id="divprincipal" className="w-full max-w-lg mx-auto my-8 p-4">
        <main className="grid justify-items-center border-collapse border-8 p-4 relative md:mr-10 bg-white">
            <div className="flex flex-row items-center border-solid border-4 border-amber-300 w-full p-3 gap-12 mb-10">
            ...
            <section className="border-dashed border-2 border-orange-500 w-full p-4">
                ...
                <div className="flex flex-col gap-4">
                    <button className="outline outline-offset-2 outline-blue-400 rounded flex items-center justify-between gap-4 w-full p-2">
                        ...
                        <input className="border-2 rounded border-zinc-100 w-20 text-center" placeholder="18" type="text"></input>
                    </button>
