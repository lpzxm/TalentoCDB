    ...
    return (
        <>
            <div className=" mt-6 flex justify-center ">
                <div className="bg-white rounded-lg shadow-md max-w-5xl border-8 w-full p-16 border-blue-500 border-solid border-opacity-50 hover:border-opacity-75 transition-opacity duration-300 ease-in-out">
