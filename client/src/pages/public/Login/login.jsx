                    ...
                    <div className="w-[335px] 800:w-96 py-24 bg-white rounded-xl flex flex-col justify-first items-center space-y-10 box-border" id="prim">
                        <div className="space-y-10 w-full flex flex-col justify-around items-center">
                            ...
                            <div className="relative flex w-full box-border px-5">
                                <input {...register("email", { required: { value: true } })} type="email" placeholder="Correo institucional" className="w-full placeholder:text-slate-400 bg-[#F9F9F9] border border-[#CCC9C9] rounded-[8px] px-4 py-2 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" />
